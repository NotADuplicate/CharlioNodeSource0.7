...
switch("Point Light") {
	case "Point Light":
		light = light_create_point(x, y, Light_Shadow_Length, Light_Color, 2000, 5);
		//sprite_index = spr_light_point;
		break;
	case "Spot Light":
		light = light_create_spot(x, y, Light_Shadow_Length, Light_Color, 2000, Light_Intensity, Light_Angle, Light_Direction);
	...
	case "Directional Light":
		light = light_create_directional(x, y, Light_Shadow_Length, Light_Color, Light_Range, Light_Intensity, point_direction(x,y,mouse_x,mouse_y));
