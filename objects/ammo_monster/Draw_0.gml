...
if(dead) { //if dead draw location where you would spawn
	//draw_sprite_ext(sprite_index,0,xpos,ypos,image_xscale,image_yscale,0,c_white,knownAlpha);
	//draw_sprite_ext(spr_ammo,0,xpos,ypos,2,2,0,c_white,knownAlpha);
}
else {
	draw_self();
	draw_sprite_ext(spr_ammo,0,x,y,2,2,0,c_white,1);
}
