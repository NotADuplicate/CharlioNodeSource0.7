...
switch("Spot Light") {
	case "Point Light":
		light = light_create_point(x, y, Light_Shadow_Length, Light_Color, 1200, Light_Intensity);
		//sprite_index = spr_light_point;
		break;
	case "Spot Light":
		light = light_create_spot(x, y, Light_Shadow_Length, Light_Color, 5000, 1.2, 16, 0);
